...
| **Persistence** | **Plain Text File (`contact.txt`)** | Simple storage solution using Java File I/O. |
...
1.  **Clone the Repository:**
    ```bash
    git clone https://github.com/nasif-irtisum/Contact-Book-Application.git
    ```
2.  **Open in NetBeans:**
    * Launch **Apache NetBeans IDE**.
    * Go to `File` > `Open Project...` and navigate to the cloned folder.
    * modify the hardcoded path to `new FileReader("src/contact.txt")` in the code.
3.  **Compile and Run:**
